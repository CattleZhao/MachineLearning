...
if __name__ == '__main__':
    ...
    print(u'随机森林回归训练集准确率：', accuracy_score(y_train, y_train_pred))
    print(u'随机森林回归测试集准确率：', accuracy_score(y_test, y_test_pred))
    ...
    params = {'booster':'gblinear','max_depth': 1, 'eta': 0.9, 'silent': 1, 'objective': 'multi:softmax', 'num_class': 3}
    bst = xgb.train(params, data_train, num_boost_round=6, evals=watchlist)
